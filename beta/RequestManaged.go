...
// ManagedDeviceComplianceRequestBuilder is request builder for ManagedDeviceCompliance
type ManagedDeviceComplianceRequestBuilder struct{ BaseRequestBuilder }

// Request returns ManagedDeviceComplianceRequest
func (b *ManagedDeviceComplianceRequestBuilder) Request() *ManagedDeviceComplianceRequest {
	return &ManagedDeviceComplianceRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ManagedDeviceComplianceRequest is request for ManagedDeviceCompliance
type ManagedDeviceComplianceRequest struct{ BaseRequest }

// Get performs GET request for ManagedDeviceCompliance
func (r *ManagedDeviceComplianceRequest) Get(ctx context.Context) (resObj *ManagedDeviceCompliance, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for ManagedDeviceCompliance
func (r *ManagedDeviceComplianceRequest) Update(ctx context.Context, reqObj *ManagedDeviceCompliance) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for ManagedDeviceCompliance
func (r *ManagedDeviceComplianceRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}

// ManagedDeviceComplianceTrendRequestBuilder is request builder for ManagedDeviceComplianceTrend
type ManagedDeviceComplianceTrendRequestBuilder struct{ BaseRequestBuilder }

// Request returns ManagedDeviceComplianceTrendRequest
func (b *ManagedDeviceComplianceTrendRequestBuilder) Request() *ManagedDeviceComplianceTrendRequest {
	return &ManagedDeviceComplianceTrendRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ManagedDeviceComplianceTrendRequest is request for ManagedDeviceComplianceTrend
type ManagedDeviceComplianceTrendRequest struct{ BaseRequest }

// Get performs GET request for ManagedDeviceComplianceTrend
func (r *ManagedDeviceComplianceTrendRequest) Get(ctx context.Context) (resObj *ManagedDeviceComplianceTrend, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for ManagedDeviceComplianceTrend
func (r *ManagedDeviceComplianceTrendRequest) Update(ctx context.Context, reqObj *ManagedDeviceComplianceTrend) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for ManagedDeviceComplianceTrend
func (r *ManagedDeviceComplianceTrendRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
...
// ManagedTenantRequestBuilder is request builder for ManagedTenant
type ManagedTenantRequestBuilder struct{ BaseRequestBuilder }

// Request returns ManagedTenantRequest
func (b *ManagedTenantRequestBuilder) Request() *ManagedTenantRequest {
	return &ManagedTenantRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ManagedTenantRequest is request for ManagedTenant
type ManagedTenantRequest struct{ BaseRequest }

// Get performs GET request for ManagedTenant
func (r *ManagedTenantRequest) Get(ctx context.Context) (resObj *ManagedTenant, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for ManagedTenant
func (r *ManagedTenantRequest) Update(ctx context.Context, reqObj *ManagedTenant) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for ManagedTenant
func (r *ManagedTenantRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
