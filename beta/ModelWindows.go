...
type Windows struct {
	// Entity is the base model of Windows
	Entity
...
// WindowsDeploymentSettings undocumented
type WindowsDeploymentSettings struct {
	// DeploymentSettings is the base model of WindowsDeploymentSettings
	DeploymentSettings
	// UserExperience undocumented
	UserExperience *UserExperienceSettings `json:"userExperience,omitempty"`
}
...
// WindowsUpdateReference undocumented
type WindowsUpdateReference struct {
	// SoftwareUpdateReference is the base model of WindowsUpdateReference
