...
// UnifiedGroupSourceRequestBuilder is request builder for UnifiedGroupSource
type UnifiedGroupSourceRequestBuilder struct{ BaseRequestBuilder }

// Request returns UnifiedGroupSourceRequest
func (b *UnifiedGroupSourceRequestBuilder) Request() *UnifiedGroupSourceRequest {
	return &UnifiedGroupSourceRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// UnifiedGroupSourceRequest is request for UnifiedGroupSource
type UnifiedGroupSourceRequest struct{ BaseRequest }

// Get performs GET request for UnifiedGroupSource
func (r *UnifiedGroupSourceRequest) Get(ctx context.Context) (resObj *UnifiedGroupSource, err error) {
	var query string
	if r.query != nil {
...
// Update performs PATCH request for UnifiedGroupSource
func (r *UnifiedGroupSourceRequest) Update(ctx context.Context, reqObj *UnifiedGroupSource) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for UnifiedGroupSource
func (r *UnifiedGroupSourceRequest) Delete(ctx context.Context) error {
