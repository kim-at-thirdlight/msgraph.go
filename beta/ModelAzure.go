...
// AzureADDevice undocumented
type AzureADDevice struct {
	// UpdatableAsset is the base model of AzureADDevice
	UpdatableAsset
	// Enrollments undocumented
	Enrollments []UpdatableAssetEnrollment `json:"enrollments,omitempty"`
	// Errors undocumented
	Errors []UpdatableAssetError `json:"errors,omitempty"`
}

// AzureADDeviceRegistrationError undocumented
type AzureADDeviceRegistrationError struct {
	// UpdatableAssetError is the base model of AzureADDeviceRegistrationError
	UpdatableAssetError
	// Reason undocumented
	Reason *AzureADDeviceRegistrationErrorReason `json:"reason,omitempty"`
}
