...
// ConditionalAccessPolicyCoverageRequestBuilder is request builder for ConditionalAccessPolicyCoverage
type ConditionalAccessPolicyCoverageRequestBuilder struct{ BaseRequestBuilder }

// Request returns ConditionalAccessPolicyCoverageRequest
func (b *ConditionalAccessPolicyCoverageRequestBuilder) Request() *ConditionalAccessPolicyCoverageRequest {
	return &ConditionalAccessPolicyCoverageRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ConditionalAccessPolicyCoverageRequest is request for ConditionalAccessPolicyCoverage
type ConditionalAccessPolicyCoverageRequest struct{ BaseRequest }

// Get performs GET request for ConditionalAccessPolicyCoverage
func (r *ConditionalAccessPolicyCoverageRequest) Get(ctx context.Context) (resObj *ConditionalAccessPolicyCoverage, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for ConditionalAccessPolicyCoverage
func (r *ConditionalAccessPolicyCoverageRequest) Update(ctx context.Context, reqObj *ConditionalAccessPolicyCoverage) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for ConditionalAccessPolicyCoverage
func (r *ConditionalAccessPolicyCoverageRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
