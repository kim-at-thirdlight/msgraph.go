...
type IOSAvailableUpdateVersion struct {
	...
	Object
	// ExpirationDateTime The expiration date of the update.
	ExpirationDateTime *time.Time `json:"expirationDateTime,omitempty"`
	// PostingDateTime The posting date of the update.
	PostingDateTime *time.Time `json:"postingDateTime,omitempty"`
	// ProductVersion The version of the update.
	ProductVersion *string `json:"productVersion,omitempty"`
	// SupportedDevices List of supported devices for the update.
...
type IOSDeviceFeaturesConfiguration struct {
	...
	// IOSSingleSignOnExtension Gets or sets a single sign-on extension profile.
	...
	// SingleSignOnExtension Gets or sets a single sign-on extension profile. Deprecated: use IOSSingleSignOnExtension instead.
...
// IOSExpeditedCheckinConfiguration Experimental profile to increase the rate of device check-ins per day of iOS devices.
...
type IOSGeneralDeviceConfiguration struct {
	...
	// AppClipsBlocked Prevents a user from adding any App Clips and removes any existing App Clips on the device.
	...
	// ApplePersonalizedAdsBlocked Limits Apple personalized advertising when true. Available in iOS 14 and later.
	...
	// AutoUnlockBlocked Blocks users from unlocking their device with Apple Watch. Available for devices running iOS and iPadOS versions 14.5 and later.
	...
	// KioskModeAppType Type of app to run in kiosk mode.
	...
	// NfcBlocked Disable NFC to prevent devices from pairing with other NFC-enabled devices. Available for iOS/iPadOS devices running 14.2 and later.
	...
	// OnDeviceOnlyDictationForced Disables connections to Siri servers so that users can’t use Siri to dictate text. Available for devices running iOS and iPadOS versions 14.5 and later.
	...
	// SharedDeviceBlockTemporarySessions Indicates whether or not to block temporary sessions on Shared iPads (iOS 13.4 or later).
	...
	// UnpairedExternalBootToRecoveryAllowed Allow users to boot devices into recovery mode with unpaired devices. Available for devices running iOS and iPadOS versions 14.5 and later.
...
type IOSHomeScreenApp struct {
	...
	// IsWebClip When true, the bundle ID will be handled as a URL for a web clip.
...
type IOSLobAppAssignmentSettings struct {
	...
	// IsRemovable Whether or not the app can be removed by the user.
...
type IOSNotificationSettings struct {
	...
	// PreviewVisibility Overrides the notification preview policy set by the user on an iOS device.
...
type IOSScepCertificateProfile struct {
	...
	// CertificateStore Target store certificate
	CertificateStore *CertificateStore `json:"certificateStore,omitempty"`
	// CustomSubjectAlternativeNames Custom Subject Alternative Name Settings. The OnPremisesUserPrincipalName variable is support as well as others documented here: http://go.microsoft.com/fwlink/?LinkId=2027630. This collection can contain a maximum of 500 elements.
	CustomSubjectAlternativeNames []CustomSubjectAlternativeName `json:"customSubjectAlternativeNames,omitempty"`
...
type IOSUpdateConfiguration struct {
	...
	// CustomUpdateTimeWindows If update schedule type is set to use time window scheduling, custom time windows when updates will be scheduled. This collection can contain a maximum of 20 elements.
	CustomUpdateTimeWindows []CustomUpdateTimeWindow `json:"customUpdateTimeWindows,omitempty"`
	// DesiredOsVersion If left unspecified, devices will update to the latest version of the OS.
...
type IOSWiFiConfiguration struct {
	...
	// DisableMacAddressRandomization If set to true, forces devices connecting using this Wi-Fi profile to present their actual Wi-Fi MAC address instead of a random MAC address. Applies to iOS 14 and later.
