...
// SoftwareUpdateCatalogEntry undocumented
type SoftwareUpdateCatalogEntry struct {
	// CatalogEntry is the base model of SoftwareUpdateCatalogEntry
	CatalogEntry
}

// SoftwareUpdateReference undocumented
type SoftwareUpdateReference struct {
	// DeployableContent is the base model of SoftwareUpdateReference
	DeployableContent
}
