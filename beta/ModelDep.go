...
type DepIOSEnrollmentProfile struct {
	...
	// RestoreCompletedScreenDisabled Indicates if Weclome screen is disabled
	...
	// UpdateCompleteScreenDisabled Indicates if Weclome screen is disabled
...
type DepMacOSEnrollmentProfile struct {
	...
	DepEnrollmentBaseProfile
	// AccessibilityScreenDisabled Indicates if Accessibility screen is disabled
