...
// ExpeditedQualityUpdateReference undocumented
type ExpeditedQualityUpdateReference struct {
	// QualityUpdateReference is the base model of ExpeditedQualityUpdateReference
	QualityUpdateReference
	// EquivalentContent undocumented
	EquivalentContent *EquivalentContentOption `json:"equivalentContent,omitempty"`
}
