...
type Windows10DeviceFirmwareConfigurationInterface struct {
	...
	// SimultaneousMultiThreading Defines whether a user is allowed to enable Simultaneous MultiThreading.
	...
	// WindowsPlatformBinaryTable Defines whether a user is allowed to enable Windows Platform Binary Table.
...
type Windows10EndpointProtectionConfiguration struct {
	...
	DeviceConfiguration
	// ApplicationGuardAllowCameraMicrophoneRedirection Gets or sets whether applications inside Microsoft Defender Application Guard can access the device’s camera and microphone.
	...
	// ApplicationGuardCertificateThumbprints Allows certain device level Root Certificates to be shared with the Microsoft Defender Application Guard container.
	...
	// DefenderAllowBehaviorMonitoring Allows or disallows Windows Defender Behavior Monitoring functionality.
	DefenderAllowBehaviorMonitoring *bool `json:"defenderAllowBehaviorMonitoring,omitempty"`
	// DefenderAllowCloudProtection To best protect your PC, Windows Defender will send information to Microsoft about any problems it finds. Microsoft will analyze that information, learn more about problems affecting you and other customers, and offer improved solutions.
	DefenderAllowCloudProtection *bool `json:"defenderAllowCloudProtection,omitempty"`
	// DefenderAllowEndUserAccess Allows or disallows user access to the Windows Defender UI. If disallowed, all Windows Defender notifications will also be suppressed.
	DefenderAllowEndUserAccess *bool `json:"defenderAllowEndUserAccess,omitempty"`
	// DefenderAllowIntrusionPreventionSystem Allows or disallows Windows Defender Intrusion Prevention functionality.
	DefenderAllowIntrusionPreventionSystem *bool `json:"defenderAllowIntrusionPreventionSystem,omitempty"`
	// DefenderAllowOnAccessProtection Allows or disallows Windows Defender On Access Protection functionality.
	DefenderAllowOnAccessProtection *bool `json:"defenderAllowOnAccessProtection,omitempty"`
	// DefenderAllowRealTimeMonitoring Allows or disallows Windows Defender Realtime Monitoring functionality.
	DefenderAllowRealTimeMonitoring *bool `json:"defenderAllowRealTimeMonitoring,omitempty"`
	// DefenderAllowScanArchiveFiles Allows or disallows scanning of archives.
	DefenderAllowScanArchiveFiles *bool `json:"defenderAllowScanArchiveFiles,omitempty"`
	// DefenderAllowScanDownloads Allows or disallows Windows Defender IOAVP Protection functionality.
	DefenderAllowScanDownloads *bool `json:"defenderAllowScanDownloads,omitempty"`
	// DefenderAllowScanNetworkFiles Allows or disallows a scanning of network files.
	DefenderAllowScanNetworkFiles *bool `json:"defenderAllowScanNetworkFiles,omitempty"`
	// DefenderAllowScanRemovableDrivesDuringFullScan Allows or disallows a full scan of removable drives. During a quick scan, removable drives may still be scanned.
	DefenderAllowScanRemovableDrivesDuringFullScan *bool `json:"defenderAllowScanRemovableDrivesDuringFullScan,omitempty"`
	// DefenderAllowScanScriptsLoadedInInternetExplorer Allows or disallows Windows Defender Script Scanning functionality.
	...
	// DefenderBlockEndUserAccess Allows or disallows user access to the Windows Defender UI. If disallowed, all Windows Defender notifications will also be suppressed.
	DefenderBlockEndUserAccess *bool `json:"defenderBlockEndUserAccess,omitempty"`
	// DefenderBlockPersistenceThroughWmiType Value indicating the behavior of Block persistence through WMI event subscription
	DefenderBlockPersistenceThroughWmiType *DefenderAttackSurfaceType `json:"defenderBlockPersistenceThroughWmiType,omitempty"`
	// DefenderCheckForSignaturesBeforeRunningScan This policy setting allows you to manage whether a check for new virus and spyware definitions will occur before running a scan.
	DefenderCheckForSignaturesBeforeRunningScan *bool `json:"defenderCheckForSignaturesBeforeRunningScan,omitempty"`
	// DefenderCloudBlockLevel Added in Windows 10, version 1709. This policy setting determines how aggressive Windows Defender Antivirus will be in blocking and scanning suspicious files. Value type is integer. This feature requires the "Join Microsoft MAPS" setting enabled in order to function.
	...
	// DefenderDaysBeforeDeletingQuarantinedMalware Time period (in days) that quarantine items will be stored on the system. Valid values 0 to 90
	DefenderDaysBeforeDeletingQuarantinedMalware *int `json:"defenderDaysBeforeDeletingQuarantinedMalware,omitempty"`
	// DefenderDetectedMalwareActions Allows an administrator to specify any valid threat severity levels and the corresponding default action ID to take.
	DefenderDetectedMalwareActions *DefenderDetectedMalwareActions `json:"defenderDetectedMalwareActions,omitempty"`
	// DefenderDisableBehaviorMonitoring Allows or disallows Windows Defender Behavior Monitoring functionality.
	...
	// DefenderDisableCloudProtection To best protect your PC, Windows Defender will send information to Microsoft about any problems it finds. Microsoft will analyze that information, learn more about problems affecting you and other customers, and offer improved solutions.
	DefenderDisableCloudProtection *bool `json:"defenderDisableCloudProtection,omitempty"`
	// DefenderDisableIntrusionPreventionSystem Allows or disallows Windows Defender Intrusion Prevention functionality.
	DefenderDisableIntrusionPreventionSystem *bool `json:"defenderDisableIntrusionPreventionSystem,omitempty"`
	// DefenderDisableOnAccessProtection Allows or disallows Windows Defender On Access Protection functionality.
	DefenderDisableOnAccessProtection *bool `json:"defenderDisableOnAccessProtection,omitempty"`
	// DefenderDisableRealTimeMonitoring Allows or disallows Windows Defender Realtime Monitoring functionality.
	DefenderDisableRealTimeMonitoring *bool `json:"defenderDisableRealTimeMonitoring,omitempty"`
	// DefenderDisableScanArchiveFiles Allows or disallows scanning of archives.
	DefenderDisableScanArchiveFiles *bool `json:"defenderDisableScanArchiveFiles,omitempty"`
	// DefenderDisableScanDownloads Allows or disallows Windows Defender IOAVP Protection functionality.
	DefenderDisableScanDownloads *bool `json:"defenderDisableScanDownloads,omitempty"`
	// DefenderDisableScanNetworkFiles Allows or disallows a scanning of network files.
	DefenderDisableScanNetworkFiles *bool `json:"defenderDisableScanNetworkFiles,omitempty"`
	// DefenderDisableScanRemovableDrivesDuringFullScan Allows or disallows a full scan of removable drives. During a quick scan, removable drives may still be scanned.
	DefenderDisableScanRemovableDrivesDuringFullScan *bool `json:"defenderDisableScanRemovableDrivesDuringFullScan,omitempty"`
	// DefenderDisableScanScriptsLoadedInInternetExplorer Allows or disallows Windows Defender Script Scanning functionality.
	...
	// DefenderEnableLowCPUPriority This policy setting allows you to enable or disable low CPU priority for scheduled scans.
	DefenderEnableLowCPUPriority *bool `json:"defenderEnableLowCpuPriority,omitempty"`
	// DefenderEnableScanIncomingMail Allows or disallows scanning of email.
	DefenderEnableScanIncomingMail *bool `json:"defenderEnableScanIncomingMail,omitempty"`
	// DefenderEnableScanMappedNetworkDrivesDuringFullScan Allows or disallows a full scan of mapped network drives.
	...
	// DefenderPotentiallyUnwantedAppAction Added in Windows 10, version 1607. Specifies the level of detection for potentially unwanted applications (PUAs). Windows Defender alerts you when potentially unwanted software is being downloaded or attempts to install itself on your computer.
	...
	// DefenderScanDirection Controls which sets of files should be monitored.
	DefenderScanDirection *DefenderRealtimeScanDirection `json:"defenderScanDirection,omitempty"`
	// DefenderScanMaxCPUPercentage Represents the average CPU load factor for the Windows Defender scan (in percent). The default value is 50. Valid values 0 to 100
	DefenderScanMaxCPUPercentage *int `json:"defenderScanMaxCpuPercentage,omitempty"`
	// DefenderScanType Selects whether to perform a quick scan or full scan.
	DefenderScanType *DefenderScanType `json:"defenderScanType,omitempty"`
	// DefenderScheduledQuickScanTime Selects the time of day that the Windows Defender quick scan should run. For example, a value of 0=12:00AM, a value of 60=1:00AM, a value of 120=2:00, and so on, up to a value of 1380=11:00PM. The default value is 120
	DefenderScheduledQuickScanTime *TimeOfDay `json:"defenderScheduledQuickScanTime,omitempty"`
	// DefenderScheduledScanDay Selects the day that the Windows Defender scan should run.
	DefenderScheduledScanDay *WeeklySchedule `json:"defenderScheduledScanDay,omitempty"`
	// DefenderScheduledScanTime Selects the time of day that the Windows Defender scan should run.
	...
	// DefenderSignatureUpdateIntervalInHours Specifies the interval (in hours) that will be used to check for signatures, so instead of using the ScheduleDay and ScheduleTime the check for new signatures will be set according to the interval. Valid values 0 to 24
	...
	// FirewallIPSecExemptionsNone Configures IPSec exemptions to no exemptions
...
type Windows10GeneralConfiguration struct {
	...
	// ActivateAppsWithVoice Specifies if Windows apps can be activated by voice.
	...
	// FindMyFiles Controls if the user can configure search to Find My Files mode, which searches files in secondary hard drives and also outside of the user profile. Find My Files does not allow users to search files or locations to which they do not have access.
...
type Windows10VpnConfiguration struct {
	...
	// CryptographySuite Cryptography Suite security settings for IKEv2 VPN in Windows10 and above
...
// Windows10XCertificateProfile Base Profile Type for Authentication Certificates (SCEP or PFX Create)
...
// Windows10XSCEPCertificateProfile Windows X SCEP Certificate configuration profile
type Windows10XSCEPCertificateProfile struct {
	...
	// ExtendedKeyUsages Extended Key Usage (EKU) settings.
	ExtendedKeyUsages []ExtendedKeyUsage `json:"extendedKeyUsages,omitempty"`
	...
	// RootCertificateID Trusted Root Certificate ID
	...
	// SubjectAlternativeNameFormats Custom AAD Attributes.
...
type Windows10XVpnConfiguration struct {
	...
	DeviceManagementResourceAccessProfileBase
	// AuthenticationCertificateID ID to the Authentication Certificate
	AuthenticationCertificateID *UUID `json:"authenticationCertificateId,omitempty"`
	// CustomXML Custom XML commands that configures the VPN connection. (UTF8 byte encoding)
	CustomXML *Binary `json:"customXml,omitempty"`
	// CustomXMLFileName Custom Xml file name.
