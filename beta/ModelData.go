...
type DataSource struct {
	// Entity is the base model of DataSource
	Entity
...
// DataSourceContainer undocumented
type DataSourceContainer struct {
	// Entity is the base model of DataSourceContainer
	Entity
	// CreatedDateTime undocumented
	CreatedDateTime *time.Time `json:"createdDateTime,omitempty"`
	// DisplayName undocumented
	...
	// Status undocumented
	Status *DataSourceContainerStatus `json:"status,omitempty"`
	// LastIndexOperation undocumented
	LastIndexOperation *CaseIndexOperation `json:"lastIndexOperation,omitempty"`
}
