...
// CloudPcConnection undocumented
type CloudPcConnection struct {
	// Entity is the base model of CloudPcConnection
	Entity
	// DisplayName undocumented
	DisplayName *string `json:"displayName,omitempty"`
...
// CloudPcDevice undocumented
type CloudPcDevice struct {
	// Entity is the base model of CloudPcDevice
	Entity
...
// CloudPcOverview undocumented
type CloudPcOverview struct {
	// Object is the base model of CloudPcOverview
	Object
	// LastRefreshedDateTime undocumented
	LastRefreshedDateTime *time.Time `json:"lastRefreshedDateTime,omitempty"`
